...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			['MintRhythm Engine Team'],
			['KittyCathy',			'mzdm',				'Main Programmer of MingRhythm Engine',					 	 'https://space.bilibili.com/392569149',					'696969'],
			[''],
			['Special Thanks'],
			['Kimi', 				'kimilogo',			'Programming support',			 							 'https://kimi.moonshot.cn/', 								'1E90FF'],
			['DeepSeek', 			'dslogo',			'Programming support',			 							 'https://chat.deepseek.com/', 								'7B68EE'],
			['NovaFlare Engine', 	'nflogo',			'Technical support',			 							 'https://github.com/beihu235/FNF-NovaFlare-Engine', 		'FF00FF'],
			[''],
			['Extra Keys Team'],
